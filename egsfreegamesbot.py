...
class bot:
    ...
    def close_popup_cookies(self):
       ...
       # WebDriverWait(self.driver, 60).until(available((By.XPATH, '//*[text()="Accept All Cookies"]'))).click()
        WebDriverWait(self.driver, 60).until(available((By.XPATH, '//*[@classname()="onetrust-close-btn-handler onetrust-close-btn-ui banner-close-button onetrust-lg ot-close-icon"]'))).click()
